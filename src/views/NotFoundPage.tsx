      ...
      <div className="bg-white shadow-xs p-8 md:p-12 text-center max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-gray-500 max-w-md mx-auto leading-relaxed">
            {t(
              `The page you are looking for "${pathname}" does not exist or may have been moved.`,
              `আপনি যে পেজটিতে যাওয়ার চেষ্টা করছেন "${pathname}" সেটি বিদ্যমান নেই অথবা সরিয়ে ফেলা হয়েছে।`
            )}
          </p>
        </div>
