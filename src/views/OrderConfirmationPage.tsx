...
export const OrderConfirmationPage: React.FC = () => {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <h2 className="text-xl font-bold mb-4">
          {t("No active order found.", "কোনো সক্রিয় অর্ডার পাওয়া যায়নি।")}
        </h2>
        <button
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-6 py-8 space-y-6">
      <SEO
        title={t(
          `Order Placed #${order.id} | Ashaal Bangladesh`,
          `অর্ডার সম্পন্ন #${order.id} | আশাল`,
        )}
        noindex={true}
      />
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 text-center space-y-3 shadow-sm">
        ...
        <h1 className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight">
          {t("Thank You for Your Order,", "আপনার অর্ডারের জন্য ধন্যবাদ,")}{" "}
          {order.shippingAddress.fullName}!
        </h1>
        <p className="text-xs sm:text-sm text-gray-500 max-w-md mx-auto">
          {t(
            "We have sent an order confirmation SMS and email with invoice details.",
            "আমরা আপনার ফোনে এবং ইমেইলে কনফার্মেশন মেসেজ ও ইনভয়েস পাঠিয়েছি।",
          )}
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-3 text-xs">
          ...
          <div className="bg-gray-50 border border-gray-200 px-3 py-1.5 rounded-lg">
            ...
            <strong className="text-gray-900 uppercase font-bold">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-6">
        <h2 className="text-base font-bold text-gray-900 pb-3 border-b border-gray-200 flex items-center gap-2">
          ...
          <span>
            {t(
              "Package Items & Delivery Address",
              "অর্ডারকৃত পণ্য ও ডেলিভারি বিবরণ",
            )}
          </span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-xs space-y-1.5">
            ...
            <div className="pt-2 flex items-center gap-1.5 text-emerald-700 font-semibold">
              ...
              <span>
                Estimated Delivery:{" "}
                {order.items[0]?.product?.estimatedDeliveryDays ||
                  "2-3 Business Days"}
              </span>
            </div>
          </div>
...
export const TrackOrderPage: React.FC = () => {
  ...
  if (!order) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <h2 className="text-xl font-bold mb-4">
          {t("No active order to track.", "ট্র্যাক করার মতো কোনো অর্ডার নেই।")}
        </h2>
        <button
          onClick={() => navigate("home")}
          className="bg-[#16a34a] hover:bg-[#15803d] text-white px-6 py-2 rounded-lg font-bold text-xs cursor-pointer"
  ...
  const steps = [
    {
      ...
      desc: "Order verified and sent to seller",
      time: "Aug 16, 09:30 AM",
      done: true,
    },
    {
      titleEn: "Packed & Dispatched",
      titleBn: "প্যাকিং সম্পন্ন",
      desc: "Seller packed the item with protective bubble wrap",
      time: "Aug 16, 02:15 PM",
      done: true,
    },
    {
      titleEn: "In Transit (DEX Sorting Hub)",
      titleBn: "ট্রানজিটে আছে",
      desc: "Arrived at Ashaal Tejgaon Sorting Hub",
      time: "Aug 17, 08:40 AM",
      done: true,
    },
    {
      titleEn: "Out for Delivery",
      titleBn: "ডেলিভারির জন্য বের হয়েছে",
      desc: "Rider Md. Tanvir is on the way to your address",
      time: "Today, 11:20 AM",
      done: true,
      current: true,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-6 py-6 space-y-6">
      <SEO
        title={t(
          `Track Package #${order.trackingNumber} | Ashaal Express (DEX)`,
          `প্যাকেজ ট্র্যাকিং #${order.trackingNumber} | আশাল`,
        )}
        noindex={true}
      />
      ...
      <div className="bg-gradient-to-r from-[#16a34a] to-[#15803d] text-white rounded-2xl p-5 sm:p-6 shadow-md flex flex-wrap items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-green-100">
            Carrier: Ashaal Express DEX Bangladesh
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-6">
        <h3 className="font-bold text-sm text-gray-900">
          {t("Delivery Progress Timeline", "ডেলিভারি টাইমলাইন")}
        </h3>
            ...
            <div key={idx} className="relative flex items-start gap-4">
              ...
              <div className="flex-1 text-xs">
                <div className="flex items-center justify-between">
                  <h4
                    className={`font-bold ${s.current ? "text-[#16a34a] text-sm" : s.done ? "text-gray-900" : "text-gray-400"}`}
                  >
                    {s.titleEn}
                  </h4>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 shadow-sm space-y-3">
        <h3 className="font-bold text-xs text-gray-800 uppercase">
          {t("Package Contents", "প্যাকেজের পণ্যসমূহ")}
        </h3>
