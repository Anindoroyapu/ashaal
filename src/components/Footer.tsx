            ...
            <ul className="space-y-2 text-[12px] text-gray-600">
              <li>
                <button
                  ...
                  className="hover:text-[#16a34a] transition-colors text-left"
                >
            ...
            <ul className="space-y-2 text-[12px] text-gray-600">
              ...
              <li>
                <button
                  ...
                  className="hover:text-[#16a34a] transition-colors text-[#16a34a] font-semibold text-left"
                >
              ...
              <div className="space-y-1.5 flex-1 min-w-0 max-w-[170px]">
                ...
                >
                  ...
                  <div className="leading-none text-left">
                    <span className="block text-[7.5px] text-gray-300 font-medium tracking-wide">
                      Available on the
                    </span>
                ...
                >
                  <svg className="w-4 h-4 shrink-0" viewBox="0 0 512 512">
                    <path
                      fill="#00C1A6"
                      d="M32.5 28.5L256 252 32.5 475.5c-4.2-4.2-6.5-10.2-6.5-16.5V53c0-9.2 4.4-17.7 11.5-24.5h-5z"
                    />
                    <path
                      fill="#0083D6"
                      d="M32.5 28.5c2.3-2.2 5-3.9 8-5 9.8-3.6 20.9-.3 27.5 5.9L348 200.5 256 252 32.5 28.5z"
                    />
                    <path
                      fill="#FF334B"
                      d="M32.5 475.5L256 252l92 51.5-280 171.1c-6.6 6.2-17.7 9.5-27.5 5.9-3-1.1-5.7-2.8-8-5z"
                    />
                    <path
                      fill="#FFD400"
                      d="M479.5 238.5l-131.5-87-92 100.5 92 51.5 131.5-87c6.6-4.4 10.5-11.8 10.5-19s-3.9-14.6-10.5-19z"
                    />
                  </svg>
                  <div className="leading-none text-left">
                    <span className="block text-[7px] text-gray-300 font-bold uppercase tracking-wider">
                      ANDROID APP ON
                    </span>
                    <span className="block text-[11px] font-bold text-white tracking-tight">
                      Google play
                ...
                >
                  <div className="w-4 h-4 bg-[#cf0a2c] rounded-[3px] flex flex-col items-center justify-center p-0.5 shrink-0">
                    ...
                    <span className="text-[4px] font-extrabold text-white leading-none">
                      HUAWEI
                    </span>
                  </div>
                  <div className="leading-none text-left">
