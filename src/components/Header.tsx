...
export const Header: React.FC = () => {
  ...
  const currentHoveredCategory =
    CATEGORIES_DATA.find((c) => c.id === activeHoverCat) || CATEGORIES_DATA[0];
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div className="flex flex-col">
                ...
                <span className="text-[9px] text-[#212121]/60 font-semibold tracking-wider uppercase">
                  BANGLADESH
                </span>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left leading-tight">
                <p className="text-[10px] text-gray-500">
                  {t("Deliver to", "ডেলিভারি ঠিকানা")}
                </p>
                <p className="font-semibold text-[#212121] text-[11px] truncate max-w-[110px]">
                  {activeLocation.city}
                </p>
              </div>
                  ...
                  <div className="flex-1 p-5 bg-white max-h-[380px] overflow-y-auto">
                    <div className="flex items-center justify-between pb-3 border-b border-[#e2e2e2] mb-4">
                      <h4 className="font-bold text-sm text-[#16a34a] flex items-center gap-2">
                        {language === "BN"
                          ? currentHoveredCategory.nameBn
                          : currentHoveredCategory.name}
                      </h4>
                      <button
                        onClick={() => {
                          navigate("search", {
                            categorySlug: currentHoveredCategory.slug,
                          });
                          setIsCategoryMenuOpen(false);
                        }}
