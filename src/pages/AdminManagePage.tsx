...
const INITIAL_VISITORS: VisitorLog[] = [
  ...
  },
  {
    ...
    page: "https://ashaa.xyz/?fbclid=IwY2xjawNTYyODEwNDA1NT...",
    platform: "Windows",
    time: "15 mins ago",
  },
  {
...
export const AdminManagePage: React.FC = () => {
  ...
  // Fetch live visitors from MySQL
  React.useEffect(() => {
  ...
  const handleSeedProducts = async () => {
    if (
      !window.confirm(
        "Sync & seed all authentic marketplace products and sample users into MySQL Database?",
      )
    )
      return;
    setIsSeeding(true);
    try {
      ...
      showToast("Successfully synced MySQL Database with fresh data!");
    } catch (err) {
  ...
  const handleSaveProduct = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        editingProduct.id
          ? "Product updated successfully in MySQL!"
  ...
  const handleSaveUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        editingUser.id
          ? "User profile updated in MySQL Database!"
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 border border-gray-200 text-center space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight">
              BetterMorning & Ashaal
            </h1>
            <p className="text-xs text-gray-500 mt-1">
              Management Portal & Cloud Firestore Control
            </p>
          </div>
            ...
            <div className="space-y-4">
                  ...
                  <p className="text-xl font-bold text-blue-900 mt-0.5">
                    {
                      allUsers.filter(
                        (u) =>
                          u.memberTier === "Gold Member" ||
                          u.memberTier === "Diamond Club",
                      ).length
                    }
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-2 pt-2">
                <div className="flex items-center gap-1.5">
                  {(["all", "customer", "admin", "seller"] as const).map(
                    (r) => (
                      <button
                        key={r}
                        ...
                        <td className="py-3 px-3">
                          <div className="flex items-center gap-1.5">
                            ...
                            {usr.token && (
                              <button
                                onClick={() =>
                                  copyToClipboard(usr.token!, "User Token")
                                }
            ...
            <div className="space-y-6">
              <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-xl space-y-2">
                ...
                <p className="text-xs text-indigo-700">
                  Ashaal & BetterMorning offers live REST HTTP endpoints and
                  direct Firestore queries for external apps, mobile apps, POS
              ...
              <div className="border border-emerald-200 bg-emerald-50/40 rounded-xl p-4 space-y-3 shadow-2xs">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className="px-2.5 py-1 bg-emerald-600 text-white rounded font-bold text-[10px] tracking-wider">
                      REST GET
                    </span>
                    <code className="font-mono text-xs font-bold text-emerald-950 bg-emerald-100 px-2 py-0.5 rounded">
                      /api/users
                    </code>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-xs font-bold text-gray-800">
                      users / Firestore Collection (Real-Time)
                    </span>
                  </div>
                  <button
                    onClick={() =>
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-3 bg-white shadow-2xs">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-xs font-bold text-gray-800">
                      Token-Controlled Cart & Favorites
                    </span>
                  </div>
                  <button
                    onClick={() =>
...
const saveFavorites = (token, ids) => localStorage.setItem(\`ash_wishlist_tok_\${token}\`, JSON.stringify(ids));`}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-purple-50/80 border border-purple-200/70 rounded-2xl">
                  ...
                  <p className="text-[11px] text-purple-700 mt-1">
                    {totalCoinsInCirculation} Coins distributed
                  </p>
                </div>
                ...
                <div className="p-4 bg-blue-50/80 border border-blue-200/70 rounded-2xl">
                  ...
                  <p className="text-[11px] text-blue-700 mt-1">
                    {pendingOrdersCount} awaiting delivery
                  </p>
                </div>
          ...
          {[
            ...
            <div className="p-8 text-center bg-gray-50 rounded-xl border border-gray-200 space-y-3">
              ...
              <h3 className="font-bold text-gray-800 text-base capitalize">
                {activeRoute.replace("-", " ")} Module Active
              </h3>
              <p className="text-xs text-gray-500 max-w-md mx-auto">
                Real-time synchronized data layer configured for {activeRoute}.
                All updates made here reflect across all cloud channels.
              </p>
              <button
                onClick={() => setActiveRoute("visitors")}
      ...
      <button
        onClick={() => {
          showToast(
            "Settings: Cloud Firestore Active | Multi-User & Token Enabled",
          );
        }}
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl border border-gray-200 my-8">
            ...
            <form onSubmit={handleSaveUser} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditingUser({
                        ...editingUser,
                        memberTier: e.target.value as any,
                      })
                    }
              ...
              <div>
                <label className="block font-semibold text-gray-700 mb-1">
                  User Token (Auto-Generated API Key)
                </label>
                <input
                  type="text"
                  value={editingUser.token || ""}
                  onChange={(e) =>
                    setEditingUser({ ...editingUser, token: e.target.value })
                  }
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-xl border border-gray-200 my-8 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Changes will reflect in real-time in Firestore
                </p>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const selectedCat = CATEGORIES_DATA.find(
